                ...
                for s in readable:
                    ...
                    # is used to communicate with a connected peer, then enters here
                        ...
                        if len(messageReceived) > 11 and messageReceived[:12] == "CHAT-REQUEST":
                            ...
                            print(
                                random_color + f"{messageReceived[3]} joined the chat room" + Fore.LIGHTBLACK_EX)
                            ...
                            print(random_color + f"{messageReceived[3]} left the chat room" + Fore.LIGHTBLACK_EX)
                        ...
                        # if it is not an empty message, show this message to the user
                            ...
                            if "#%#" in str(messageReceived):
                                messageReceived = messageReceived.split("#%#")
                                print(random_color + messageReceived[0] + ": " + messageReceived[
